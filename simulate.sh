...
### Job name
#SBATCH --job-name=simulate                            # Change job name
...
### Output & Error
#SBATCH --output=/lustre/lacombres/simulate-%j.out        # Change output name
#SBATCH --error=/lustre/lacombres/simulate-%j.err         # Change error name
